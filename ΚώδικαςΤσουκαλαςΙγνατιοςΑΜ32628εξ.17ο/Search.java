...
public class Search extends JFrame {
	...
	private JPanel getJContentPane() {
		if (jContentPane == null) {
			...
			jLabelFound.setBounds(new Rectangle(130, 80, 170, 30));
			jLabelFound.setFont(new Font("Dialog", Font.BOLD, 12));
			jLabelFound.setForeground(Color.red);
			jLabelFound.setText("");
			jLabelName = new JLabel();
			jLabelName.setBounds(new Rectangle(30, 30, 61, 32));
	...
	private JTextField getJTextFieldName() {
		if (jTextFieldName == null) {
			...
			jTextFieldName.setBounds(new Rectangle(130, 35, 160, 30));
		}
	...
	private JButton getJButtonSearch() {
		if (jButtonSearch == null) {
			...
			jButtonSearch.setBounds(new Rectangle(170, 130, 120, 30));
			...
			jButtonSearch.addActionListener(new java.awt.event.ActionListener() {
				public void actionPerformed(java.awt.event.ActionEvent e) {
					...
					try {
						...
						{
							jLabelFound.setText("The search returns no results, please try again!");
						}
